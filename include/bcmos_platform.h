...
typedef enum
{
    ...
    BCMOS_MODULE_ID_USER_APPL_EON = BCMOS_MODULE_ID_USER_APPL_ITU_RSSI_DEV0 + BCMTR_MAX_DEVICES,
    ...
    BCMOS_MODULE_ID_DPOE2_TRANSPORT,            /** DPoE2 Transport module */
