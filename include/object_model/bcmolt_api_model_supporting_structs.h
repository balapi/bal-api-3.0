...
#define BCMOLT_XGPON_BURST_PROFILE_PRESENCE_MASK_ALL 0x0000000000001FFFULL
...
{
    bcmolt_presence_mask presence_mask;
    bcmolt_epon_tunnel_id min; 
    bcmolt_epon_tunnel_id max; 
} bcmolt_epon_tunnel_id_range;


#define BCMOLT_EPON_TUNNEL_ID_RANGE_PRESENCE_MASK_ALL 0x0000000000000003ULL
...
#define BCMOLT_XGPON_PON_PARAMS_PRESENCE_MASK_ALL 0x0000000000000FFFULL
