...
typedef struct
{
    ...
    bcmolt_epon_tunnel_id_range epon_tunnel_id_range; 
    bcmolt_shaper_mode epon_shaper_mode; 
...
#define BCMOLT_DEVICE_CFG_DATA_PRESENCE_MASK_ALL 0x00000000383FFEFFULL
...
#define BCMOLT_FLOW_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000FFFULL
...
#define BCMOLT_GROUP_CFG_DATA_PRESENCE_MASK_ALL 0x000000000000000FULL
...
#define BCMOLT_NNI_INTERFACE_STATE_CHANGE_DATA_PRESENCE_MASK_ALL 0x0000000000000003ULL
...
#define BCMOLT_NNI_INTERFACE_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000001ULL
...
#define BCMOLT_NNI_INTERFACE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000001ULL
...
#define BCMOLT_ONU_RANGING_COMPLETED_DATA_PRESENCE_MASK_ALL 0x000000000000001FULL
...
typedef struct
{
    ...
    bcmos_mac_address link_mac; 
    bcmolt_time_quanta range_value_tq; 
} bcmolt_pon_interface_llid_quarantined_data;


#define BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_PRESENCE_MASK_ALL 0x000000000000000FULL
...
typedef struct
{
    bcmolt_auto hdr; 
    bcmolt_pon_interface_key key; 
    bcmolt_pon_interface_llid_quarantined_data data; 
} bcmolt_pon_interface_llid_quarantined;


typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmolt_ieee_link link_idx; 
} bcmolt_pon_interface_epon_link_created_data;


#define BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_PRESENCE_MASK_ALL 0x0000000000000001ULL
...
typedef struct
{
    bcmolt_auto hdr; 
    bcmolt_pon_interface_key key; 
    bcmolt_pon_interface_epon_link_created_data data; 
} bcmolt_pon_interface_epon_link_created;
...
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmos_mac_address link_mac; 
    bcmolt_onu_rate link_speed; 
    bcmos_mac_address onu_base_mac; 
    bcmolt_epon_link_create_error error; 
} bcmolt_pon_interface_epon_link_creation_failed_data;


#define BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_PRESENCE_MASK_ALL 0x000000000000000FULL
...
typedef struct
{
    bcmolt_auto hdr; 
    bcmolt_pon_interface_key key; 
    bcmolt_pon_interface_epon_link_creation_failed_data data; 
} bcmolt_pon_interface_epon_link_creation_failed;
...
typedef struct
{
    ...
    bcmos_bool epon_link_created; 
    bcmos_bool epon_link_creation_failed; 
    bcmos_bool llid_quarantined; 
    bcmos_bool los; 
...
#define BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x000000000007FFFFULL
