...
typedef enum
{
    BCMOLT_EPON_LINK_CREATE_ERROR__BEGIN = 0,
    BCMOLT_EPON_LINK_CREATE_ERROR_MPCP_REG_ACK_TIMEOUT = 0, 
    BCMOLT_EPON_LINK_CREATE_ERROR_OUT_OF_RESOURCES = 1, 
    BCMOLT_EPON_LINK_CREATE_ERROR_PROVISIONING_NOT_FOUND = 2, 
    BCMOLT_EPON_LINK_CREATE_ERROR_OAM_NEGOTATION_FAILED = 3, 
    BCMOLT_EPON_LINK_CREATE_ERROR__NUM_OF, 
} bcmolt_epon_link_create_error;
...
typedef enum
{
    BCMOLT_FLOW_INTERFACE_TYPE__BEGIN = 0,
    BCMOLT_FLOW_INTERFACE_TYPE_PON = 0, 
    BCMOLT_FLOW_INTERFACE_TYPE_NNI = 1, 
    BCMOLT_FLOW_INTERFACE_TYPE_HOST = 2, 
    BCMOLT_FLOW_INTERFACE_TYPE_NONE = 3, 
    BCMOLT_FLOW_INTERFACE_TYPE__NUM_OF, 
...
typedef enum
{
    ...
    BCMOLT_INTERFACE_TYPE_EPON_1_G = 3, 
    BCMOLT_INTERFACE_TYPE_EPON_10_G = 4, 
    BCMOLT_INTERFACE_TYPE_NONE = 5, 
...
typedef enum
{
    ...
    BCMOLT_SHAPER_MODE_LAYER_1 = 0, 
    BCMOLT_SHAPER_MODE_LAYER_2 = 1, 
    BCMOLT_SHAPER_MODE__NUM_OF, 
} bcmolt_shaper_mode;
...
typedef enum
{
    BCMOLT_TM_QUEUE_STATE__BEGIN = 0,
    BCMOLT_TM_QUEUE_STATE_NOT_CONFIGURED = 0, 
    BCMOLT_TM_QUEUE_STATE_ACTIVE = 1, 
    BCMOLT_TM_QUEUE_STATE__NUM_OF, 
} bcmolt_tm_queue_state;
...
#define bcmolt_obj_id_full_mask 0x7FF83F2
...
typedef enum
{
    ...
    BCMOLT_API_GROUP_ID_FLOW_CFG = 22, 
    BCMOLT_API_GROUP_ID_FLOW_KEY = 23, 
    BCMOLT_API_GROUP_ID_FLOW_SEND_ETH_PACKET = 24, 
    BCMOLT_API_GROUP_ID_FLOW_RECEIVE_ETH_PACKET = 25, 
    BCMOLT_API_GROUP_ID_FLOW_AUTO_CFG = 26, 
    BCMOLT_API_GROUP_ID_GPIO_KEY = 27, 
    BCMOLT_API_GROUP_ID_GPIO_CFG = 28, 
    BCMOLT_API_GROUP_ID_GROUP_CFG = 29, 
    BCMOLT_API_GROUP_ID_GROUP_KEY = 30, 
    BCMOLT_API_GROUP_ID_GROUP_MEMBERS_UPDATE = 31, 
    BCMOLT_API_GROUP_ID_GROUP_COMPLETE_MEMBERS_UPDATE = 32, 
    BCMOLT_API_GROUP_ID_GROUP_AUTO_CFG = 33, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_KEY = 34, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_CFG = 35, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_STATUS_CHANGED = 36, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_AUTO_CFG = 37, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_KEY = 38, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CFG = 39, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CONFIGURATION_COMPLETED = 40, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_STATS = 41, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_ALLOC_STATS_COMPLETED = 42, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_SET_STATE = 43, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_AUTO_CFG = 44, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_KEY = 45, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CFG = 46, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CONFIGURATION_COMPLETED = 47, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_SET_STATE = 48, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_AUTO_CFG = 49, 
    BCMOLT_API_GROUP_ID_LOG_KEY = 50, 
    BCMOLT_API_GROUP_ID_LOG_CFG = 51, 
    BCMOLT_API_GROUP_ID_LOG_FILE_KEY = 52, 
    BCMOLT_API_GROUP_ID_LOG_FILE_CFG = 53, 
    BCMOLT_API_GROUP_ID_LOG_FILE_CLEAR = 54, 
    BCMOLT_API_GROUP_ID_LOG_FILE_RESET_BUFFER_PTR = 55, 
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_KEY = 56, 
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_CFG = 57, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_KEY = 58, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_STATE_CHANGE = 59, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_CFG = 60, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_SET_NNI_STATE = 61, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_AUTO_CFG = 62, 
    BCMOLT_API_GROUP_ID_OLT_KEY = 63, 
    BCMOLT_API_GROUP_ID_OLT_CFG = 64, 
    BCMOLT_API_GROUP_ID_OLT_CONNECT = 65, 
    BCMOLT_API_GROUP_ID_OLT_CONNECTED = 66, 
    BCMOLT_API_GROUP_ID_OLT_DISCONNECT = 67, 
    BCMOLT_API_GROUP_ID_OLT_BAL_RESET = 68, 
    BCMOLT_API_GROUP_ID_OLT_DISCONNECTED = 69, 
    BCMOLT_API_GROUP_ID_OLT_BAL_FAILURE = 70, 
    BCMOLT_API_GROUP_ID_OLT_BAL_READY = 71, 
    BCMOLT_API_GROUP_ID_OLT_SW_ERROR = 72, 
    BCMOLT_API_GROUP_ID_OLT_RESET = 73, 
    BCMOLT_API_GROUP_ID_OLT_AUTO_CFG = 74, 
    BCMOLT_API_GROUP_ID_ONU_KEY = 75, 
    BCMOLT_API_GROUP_ID_ONU_CFG = 76, 
    BCMOLT_API_GROUP_ID_ONU_SET_ONU_STATE = 77, 
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT = 78, 
    BCMOLT_API_GROUP_ID_ONU_REQUEST_REGISTRATION = 79, 
    BCMOLT_API_GROUP_ID_ONU_CHANGE_POWER_LEVELLING = 80, 
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_LEVEL = 81, 
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_CONSUMPTION = 82, 
    BCMOLT_API_GROUP_ID_ONU_ADJUST_TX_WAVELENGTH = 83, 
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION = 84, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_IN = 85, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_OUT = 86, 
    BCMOLT_API_GROUP_ID_ONU_XGPON_ALARM = 87, 
    BCMOLT_API_GROUP_ID_ONU_GPON_ALARM = 88, 
    BCMOLT_API_GROUP_ID_ONU_DOWI = 89, 
    BCMOLT_API_GROUP_ID_ONU_SFI = 90, 
    BCMOLT_API_GROUP_ID_ONU_SDI = 91, 
    BCMOLT_API_GROUP_ID_ONU_DFI = 92, 
    BCMOLT_API_GROUP_ID_ONU_PQSI = 93, 
    BCMOLT_API_GROUP_ID_ONU_SUFI = 94, 
    BCMOLT_API_GROUP_ID_ONU_TIWI = 95, 
    BCMOLT_API_GROUP_ID_ONU_LOOCI = 96, 
    BCMOLT_API_GROUP_ID_ONU_LOAI = 97, 
    BCMOLT_API_GROUP_ID_ONU_DGI = 98, 
    BCMOLT_API_GROUP_ID_ONU_PEE = 99, 
    BCMOLT_API_GROUP_ID_ONU_PST = 100, 
    BCMOLT_API_GROUP_ID_ONU_RANGING_COMPLETED = 101, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_COMPLETED = 102, 
    BCMOLT_API_GROUP_ID_ONU_ONU_DEACTIVATION_COMPLETED = 103, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ENABLE_COMPLETED = 104, 
    BCMOLT_API_GROUP_ID_ONU_ONU_DISABLE_COMPLETED = 105, 
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT_COMPLETED = 106, 
    BCMOLT_API_GROUP_ID_ONU_INVALID_DBRU_REPORT = 107, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_COMPLETED = 108, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_REQUEST_TIMEOUT = 109, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_CYCLE_SKIPPED = 110, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_MISMATCH = 111, 
    BCMOLT_API_GROUP_ID_ONU_OPTICAL_REFLECTION = 112, 
    BCMOLT_API_GROUP_ID_ONU_LOKI = 113, 
    BCMOLT_API_GROUP_ID_ONU_MEMI = 114, 
    BCMOLT_API_GROUP_ID_ONU_OMCI_PORT_ID_CONFIGURATION_COMPLETED = 115, 
    BCMOLT_API_GROUP_ID_ONU_BER_INTERVAL_CONFIGURATION_COMPLETED = 116, 
    BCMOLT_API_GROUP_ID_ONU_ERR = 117, 
    BCMOLT_API_GROUP_ID_ONU_PASSWORD_AUTHENTICATION_COMPLETED = 118, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_UNCONSECUTIVE_INDEX = 119, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_DECRYPT_REQUIRED = 120, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_STANDBY_COMPLETED = 121, 
    BCMOLT_API_GROUP_ID_ONU_POWER_MANAGEMENT_STATE_CHANGE = 122, 
    BCMOLT_API_GROUP_ID_ONU_POSSIBLE_DRIFT = 123, 
    BCMOLT_API_GROUP_ID_ONU_REGISTRATION_ID = 124, 
    BCMOLT_API_GROUP_ID_ONU_POWER_LEVEL_REPORT = 125, 
    BCMOLT_API_GROUP_ID_ONU_POWER_CONSUMPTION_REPORT = 126, 
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION_FAILURE = 127, 
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_OUT_COMPLETED = 128, 
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_IN_COMPLETED = 129, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_RESPONSE = 130, 
    BCMOLT_API_GROUP_ID_ONU_PLOAM_PACKET = 131, 
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKETS = 132, 
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKET = 133, 
    BCMOLT_API_GROUP_ID_ONU_OMCI_PACKET = 134, 
    BCMOLT_API_GROUP_ID_ONU_ONU_READY_FOR_DATA_GRANT = 135, 
    BCMOLT_API_GROUP_ID_ONU_REI = 136, 
    BCMOLT_API_GROUP_ID_ONU_FORCE_DEACTIVATION = 137, 
    BCMOLT_API_GROUP_ID_ONU_STATE_CHANGE = 138, 
    BCMOLT_API_GROUP_ID_ONU_AUTO_CFG = 139, 
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_KEY = 140, 
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_CFG = 141, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_KEY = 142, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CFG = 143, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_PON_INTERFACE_STATE = 144, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_ONU_STATE = 145, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RESET = 146, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_SERIAL_NUMBER = 147, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SINGLE_REQUEST_STANDBY_PON_MONITORING = 148, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RUN_SPECIAL_BW_MAP = 149, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST = 150, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_START_ONU_UPGRADE = 151, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ABORT_ONU_UPGRADE = 152, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TYPE_C_SET_MULTIPLE_ONU_STATE = 153, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_APPLY_RERANGE_DELTA = 154, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS = 155, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_BROADCAST_PLOAM_PACKET = 156, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STATE_CHANGE_COMPLETED = 157, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST_COMPLETED = 158, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_LOS = 159, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 160, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TRAFFIC_RESUME = 161, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_ONUS_RANGED = 162, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_RERANGE_FAILURE = 163, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 164, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 165, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_DISCOVERED = 166, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS_FAILURE = 167, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DEACTIVATE_ALL_ONUS_COMPLETED = 168, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_ALL_ONUS_COMPLETED = 169, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ACTIVATE_ALL_ONUS_COMPLETED = 170, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ENABLE_ALL_ONUS_COMPLETED = 171, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_UPGRADE_COMPLETE = 172, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_LLID_QUARANTINED = 173, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_EPON_LINK_CREATED = 174, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_EPON_LINK_CREATION_FAILED = 175, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_AUTO_CFG = 176, 
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_KEY = 177, 
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_CFG = 178, 
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_KEY = 179, 
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_CFG = 180, 
    BCMOLT_API_GROUP_ID_TM_QUEUE_KEY = 181, 
    BCMOLT_API_GROUP_ID_TM_QUEUE_CFG = 182, 
    BCMOLT_API_GROUP_ID_TM_SCHED_KEY = 183, 
    BCMOLT_API_GROUP_ID_TM_SCHED_CFG = 184, 
...
typedef enum
{
    ...
    BCMOLT_NNI_INTERFACE_AUTO_SUBGROUP_STATE_CHANGE = 1, 
...
#define bcmolt_nni_interface_auto_subgroup_full_mask 0x3
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_EPON_LINK_CREATED = 6, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_EPON_LINK_CREATION_FAILED = 7, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_LLID_QUARANTINED = 8, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_LOS = 9, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_DISCOVERED = 10, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_UPGRADE_COMPLETE = 11, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_ONUS_RANGED = 12, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_RERANGE_FAILURE = 13, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 14, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_TRAFFIC_RESUME = 15, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 16, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 17, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STATE_CHANGE_COMPLETED = 18, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_TOD_REQUEST_COMPLETED = 19, 
...
#define bcmolt_pon_interface_auto_subgroup_epon_link_created BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_EPON_LINK_CREATED
#define bcmolt_pon_interface_auto_subgroup_epon_link_creation_failed BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_EPON_LINK_CREATION_FAILED
#define bcmolt_pon_interface_auto_subgroup_llid_quarantined BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_LLID_QUARANTINED
...
#define bcmolt_pon_interface_auto_subgroup_full_mask 0xFFFFF
...
typedef enum
{
    BCMOLT_EPON_TUNNEL_ID_RANGE_ID__BEGIN = 0,
    BCMOLT_EPON_TUNNEL_ID_RANGE_ID_MIN = 0, 
    BCMOLT_EPON_TUNNEL_ID_RANGE_ID_MAX = 1, 
    BCMOLT_EPON_TUNNEL_ID_RANGE_ID__NUM_OF, 

    
#define bcmolt_epon_tunnel_id_range_id__begin BCMOLT_EPON_TUNNEL_ID_RANGE_ID__BEGIN
#define bcmolt_epon_tunnel_id_range_id_min BCMOLT_EPON_TUNNEL_ID_RANGE_ID_MIN
#define bcmolt_epon_tunnel_id_range_id_max BCMOLT_EPON_TUNNEL_ID_RANGE_ID_MAX
#define bcmolt_epon_tunnel_id_range_id__num_of BCMOLT_EPON_TUNNEL_ID_RANGE_ID__NUM_OF
#define bcmolt_epon_tunnel_id_range_id_all_properties 0xFF
#define bcmolt_epon_tunnel_id_range_id_full_mask 0x3

} bcmolt_epon_tunnel_id_range_id;
...
typedef enum
{
    ...
    BCMOLT_XGPON_BURST_PROFILE_ID_IS_FEC_ON = 1, 
    BCMOLT_XGPON_BURST_PROFILE_ID_DELIMITER_SIZE_IN_BYTES = 2, 
    BCMOLT_XGPON_BURST_PROFILE_ID_DELIMITER_PATTERN_HIGH = 3, 
    BCMOLT_XGPON_BURST_PROFILE_ID_DELIMITER_PATTERN_LOW = 4, 
    BCMOLT_XGPON_BURST_PROFILE_ID_PREAMBLE_LENGTH_IN_BYTES = 5, 
    BCMOLT_XGPON_BURST_PROFILE_ID_PREAMBLE_REPEATS_COUNT = 6, 
    BCMOLT_XGPON_BURST_PROFILE_ID_PREAMBLE_PATTERN_HIGH = 7, 
    BCMOLT_XGPON_BURST_PROFILE_ID_PREAMBLE_PATTERN_LOW = 8, 
    BCMOLT_XGPON_BURST_PROFILE_ID_PON_TAG = 9, 
    BCMOLT_XGPON_BURST_PROFILE_ID_NUM_OF_GUARD_BYTES = 10, 
    BCMOLT_XGPON_BURST_PROFILE_ID_IS_PROFILE_VALID = 11, 
    BCMOLT_XGPON_BURST_PROFILE_ID_BURST_OVERHEAD_SIZE_IN_WORDS = 12, 
...
#define bcmolt_xgpon_burst_profile_id_full_mask 0x1FFF
...
#define bcmolt_xgpon_pon_params_id_full_mask 0xFFF
...
typedef enum
{
    ...
    BCMOLT_DEVICE_CFG_DATA_ID_EPON_TUNNEL_ID_RANGE = 14, 
    BCMOLT_DEVICE_CFG_DATA_ID_EPON_SHAPER_MODE = 15, 
...
#define bcmolt_device_cfg_data_id_epon_tunnel_id_range BCMOLT_DEVICE_CFG_DATA_ID_EPON_TUNNEL_ID_RANGE
#define bcmolt_device_cfg_data_id_epon_shaper_mode BCMOLT_DEVICE_CFG_DATA_ID_EPON_SHAPER_MODE
...
#define bcmolt_device_cfg_data_id_full_mask 0x383FFEFF
...
#define bcmolt_flow_cfg_data_id_full_mask 0xFFF
...
#define bcmolt_group_cfg_data_id_full_mask 0xF
...
typedef enum
{
    ...
    BCMOLT_NNI_INTERFACE_STATE_CHANGE_DATA_ID_OLD_STATE = 0, 
    BCMOLT_NNI_INTERFACE_STATE_CHANGE_DATA_ID_NEW_STATE = 1, 
...
#define bcmolt_nni_interface_state_change_data_id_full_mask 0x3
...
#define bcmolt_nni_interface_cfg_data_id_full_mask 0x1
...
typedef enum
{
    ...
    BCMOLT_NNI_INTERFACE_AUTO_CFG_DATA_ID_STATE_CHANGE = 0, 
...
#define bcmolt_nni_interface_auto_cfg_data_id_full_mask 0x1
...
typedef enum
{
    ...
    BCMOLT_ONU_RANGING_COMPLETED_DATA_ID_POWER_LEVEL = 4, 
...
#define bcmolt_onu_ranging_completed_data_id_power_level BCMOLT_ONU_RANGING_COMPLETED_DATA_ID_POWER_LEVEL
...
#define bcmolt_onu_ranging_completed_data_id_full_mask 0x1F
...
typedef enum
{
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID__BEGIN = 0,
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LLID = 0, 
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LINK_RATE = 1, 
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LINK_MAC = 2, 
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_RANGE_VALUE_TQ = 3, 
    BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID__NUM_OF, 

    
#define bcmolt_pon_interface_llid_quarantined_data_id__begin BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID__BEGIN
#define bcmolt_pon_interface_llid_quarantined_data_id_llid BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LLID
#define bcmolt_pon_interface_llid_quarantined_data_id_link_rate BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LINK_RATE
#define bcmolt_pon_interface_llid_quarantined_data_id_link_mac BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_LINK_MAC
#define bcmolt_pon_interface_llid_quarantined_data_id_range_value_tq BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID_RANGE_VALUE_TQ
#define bcmolt_pon_interface_llid_quarantined_data_id__num_of BCMOLT_PON_INTERFACE_LLID_QUARANTINED_DATA_ID__NUM_OF
#define bcmolt_pon_interface_llid_quarantined_data_id_all_properties 0xFF
#define bcmolt_pon_interface_llid_quarantined_data_id_full_mask 0xF

} bcmolt_pon_interface_llid_quarantined_data_id;


typedef enum
{
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID__BEGIN = 0,
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID_LINK_IDX = 0, 
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID__NUM_OF, 

    
#define bcmolt_pon_interface_epon_link_created_data_id__begin BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID__BEGIN
#define bcmolt_pon_interface_epon_link_created_data_id_link_idx BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID_LINK_IDX
#define bcmolt_pon_interface_epon_link_created_data_id__num_of BCMOLT_PON_INTERFACE_EPON_LINK_CREATED_DATA_ID__NUM_OF
#define bcmolt_pon_interface_epon_link_created_data_id_all_properties 0xFF
#define bcmolt_pon_interface_epon_link_created_data_id_full_mask 0x1

} bcmolt_pon_interface_epon_link_created_data_id;


typedef enum
{
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID__BEGIN = 0,
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_LINK_MAC = 0, 
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_LINK_SPEED = 1, 
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_ONU_BASE_MAC = 2, 
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_ERROR = 3, 
    BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID__NUM_OF, 

    
#define bcmolt_pon_interface_epon_link_creation_failed_data_id__begin BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID__BEGIN
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_link_mac BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_LINK_MAC
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_link_speed BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_LINK_SPEED
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_onu_base_mac BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_ONU_BASE_MAC
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_error BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID_ERROR
#define bcmolt_pon_interface_epon_link_creation_failed_data_id__num_of BCMOLT_PON_INTERFACE_EPON_LINK_CREATION_FAILED_DATA_ID__NUM_OF
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_all_properties 0xFF
#define bcmolt_pon_interface_epon_link_creation_failed_data_id_full_mask 0xF

} bcmolt_pon_interface_epon_link_creation_failed_data_id;
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_EPON_LINK_CREATED = 5, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_EPON_LINK_CREATION_FAILED = 6, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_LLID_QUARANTINED = 7, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_LOS = 8, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_DISCOVERED = 9, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_UPGRADE_COMPLETE = 10, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_ONUS_RANGED = 11, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_RERANGE_FAILURE = 12, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 13, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_TRAFFIC_RESUME = 14, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 15, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 16, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STATE_CHANGE_COMPLETED = 17, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_TOD_REQUEST_COMPLETED = 18, 
...
#define bcmolt_pon_interface_auto_cfg_data_id_epon_link_created BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_EPON_LINK_CREATED
#define bcmolt_pon_interface_auto_cfg_data_id_epon_link_creation_failed BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_EPON_LINK_CREATION_FAILED
#define bcmolt_pon_interface_auto_cfg_data_id_llid_quarantined BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_LLID_QUARANTINED
...
#define bcmolt_pon_interface_auto_cfg_data_id_full_mask 0x7FFFF
...
#define bcmolt_tm_queue_key_id_full_mask 0x5
