 ...
 * \returns BCM_ERR_OK or error code
 */
bcmos_errno bcmtr_client_connected(bcmolt_conn_type mode, bcmolt_subchannel subch, bcmolt_ldid device);

/** Client disconnected indication
 * \param[in]   mode            Mode: managed/unmanaged
 * \param[in]   subch           Subchannel
 */
void bcmtr_client_disconnected(bcmolt_conn_type mode, bcmolt_subchannel subch);
