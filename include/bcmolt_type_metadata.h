...
struct bcmolt_type_descr
{
    ...
    union
    {
        const bcmolt_enum_val *e;                    /* Enum value array - the last value has name=NULL */
        struct
        {
...
/* Function pointer: xx_get_packed_length: Get the packed length of a structure. */
typedef uint32_t (*bcmolt_func_packed_len)(void *this_entity);

/* Function pointer: xx_pack: Pack a structure to a byte stream. */
typedef bcmos_bool (*bcmolt_func_pack)(void *this_entity, bcmolt_buf *buf);

/* Function pointer: xx_unpack: Unpack a structure from a byte stream. */
typedef bcmos_bool (*bcmolt_func_unpack)(void *this_entity, bcmolt_buf *buf, void **extra_mem);

/* Function pointer: xx_mem_scan: Scan for additional memory needed by a structure. */
typedef bcmos_bool (*bcmolt_func_mem_scan)(bcmolt_buf *buf, uint32_t *extra_mem);

/* Function pointer: xx_multi_pack: Pack a multi-object container to a byte stream. */
typedef bcmos_errno (*bcmolt_func_multi_pack)(void *this_entity, bcmolt_buf *buf);

/* Function pointer: xx_multi_unpack: Unpack a multi-object container from a byte stream, allocating if necessary. */
typedef bcmos_errno (*bcmolt_func_multi_unpack)(bcmolt_buf *buf, const void *hdr, void **msg);
...
typedef struct
{
    ...
    bcmolt_func_packed_len get_packed_length; /* Pointer to the group's 'xx_multi_get_packed_length' function */
    bcmolt_func_multi_pack pack;              /* Pointer to the group's 'xx_multi_pack' function */
    bcmolt_func_multi_unpack unpack;          /* Pointer to the group's 'xx_multi_unpack' function */
...
typedef struct
{
    ...
    bcmolt_func_packed_len get_packed_length; /* Pointer to the group's 'xx_get_packed_length' function */
    bcmolt_func_pack pack;                    /* Pointer to the group's 'xx_pack' function */
    bcmolt_func_unpack unpack;                /* Pointer to the group's 'xx_unpack' function */
    bcmolt_func_mem_scan mem_scan;            /* Pointer to the group's 'xx_mem_scan' function */
